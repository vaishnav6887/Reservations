        ...
        return (
            <section className="add-reservation">
                ...
                <section className="input-container">
                    ...
                    <input type='text' placeholder="Enter Guest's Name" name="guestname" onBlur={this.onBlur} />
                </section>
                <section className="input-container">
                    <section>Hotel Name: </section>
                    <input type='text' placeholder="Enter Hotel's Name" name="hotelname" onBlur={this.onBlur} />
                </section>
                <section className="input-container">
                    <section>Arrival Date: </section>
                    <input type="date" id='arrivalDate' name='arrivaldate' required onBlur={this.onBlur} />
                </section>
                <section className="input-container">
                    <section>Departure Date: </section>
                    <input type="date" id='departureDate' name='departuredate' required onBlur={this.onBlur} />
                </section>
                <section className="input-container">
                    <button type="button" value="Search" onClick={this.onClick}>Add</button>
                </section>
            </section>
        )
    }
